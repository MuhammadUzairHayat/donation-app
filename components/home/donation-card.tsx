    ...
    <Card className="flex flex-col justify-between min-h-72 border-secondary/20 hover:shadow-[0_0_10px_rgba(0,128,255,0.3)] hover:border-secondary hover:-translate-y-5 transition-all duration-300">
      <CardHeader className="space-y-1">
        <div className="flex items-center justify-between">
          <CardTitle className="text-xl">Donation</CardTitle>
          <Heart className="h-5 w-5 text-secondary" />
        </div>
      </CardHeader>
      <CardContent>
        <CardDescription>
          Record general donations for various causes
        </CardDescription>
        
        <p className="text-sm text-muted-foreground">
          Track all charitable donations with detailed records and receipts.
        </p>
      </CardContent>
      <CardFooter>
        <Button
        ...
        >
          <Link href="/new?type=donation" className="group">
            Add Donation{" "}
